...
-   [WPacked](https://github.com/enricodeleo/wpacked) - Be ready in less than a minute on your local machine without any requirement. PHP all the way, in a fashionable self-contained package ready to be deploied.
