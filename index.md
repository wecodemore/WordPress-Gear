...
-   [Auto login](https://github.com/szepeviktor/wordpress-plugin-construction/blob/master/mu-auto-login/auto-login.php) - An MU plugin to log in without username and password. A username should be `define()`-d in wp-config.
